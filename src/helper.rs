// Vendored from supertone-inc/supertonic @ v3.0.0 (rust/src/helper.rs), copied
// verbatim — edit upstream, not here.
// Source:  https://github.com/supertone-inc/supertonic/blob/v3.0.0/rust/src/helper.rs
// License: MIT — Copyright (c) 2025 Supertone Inc. (full text in THIRD_PARTY_LICENSES)
